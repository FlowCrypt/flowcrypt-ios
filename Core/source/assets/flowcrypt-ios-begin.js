...
//     let bytesAsNumberArr = window.webkit.messageHandlers.coreHost.getSecureRandomByteNumberArray(byteCount);
...
// const setTimeout = (cb, ms) => window.webkit.messageHandlers.coreHost.setTimeout(cb, ms);
// const clearTimeout = (id) => window.webkit.messageHandlers.coreHost.clearTimeout(id);
