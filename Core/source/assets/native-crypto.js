...
if (typeof window.webkit.messageHandlers.coreHost === 'undefined') {
...
const hostRsaDecryption = async (ASN1, BN, c_encrypted, n, e, d, p, q) => {
  ...
  const decryptedBase64 = await window.webkit.messageHandlers.decryptRsaNoPadding(derRsaPrvBase64, encryptedBase64);
