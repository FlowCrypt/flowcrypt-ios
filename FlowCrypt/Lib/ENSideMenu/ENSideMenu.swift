...
open class ENSideMenu: NSObject, UIGestureRecognizerDelegate {
    ...
    open var allowslideGesture: Bool = false
     ...
     */
    public init(sourceView: UIView, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffect.Style = .dark) {
        super.init()
     ...
     */
    public convenience init(sourceView: UIView, menuViewController: UIViewController, menuPosition: ENSideMenuPosition, blurStyle: UIBlurEffect.Style = .dark) {
